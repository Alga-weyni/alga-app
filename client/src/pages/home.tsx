      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-8">
            <h3 className="text-2xl font-bold text-neutral-dark">Featured Stays</h3>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card>
              <CardContent className="p-6 text-center">
                <div className="w-12 h-12 bg-eth-green/10 rounded-lg flex items-center justify-center mx-auto mb-4">
                  <Star className="h-6 w-6 text-eth-green" />
                </div>
            ...
            <Card>
              <CardContent className="p-6 text-center">
                <div className="w-12 h-12 bg-eth-yellow/10 rounded-lg flex items-center justify-center mx-auto mb-4">
                  <TrendingUp className="h-6 w-6 text-eth-yellow" />
                </div>
                <h4 className="text-2xl font-bold text-neutral-dark mb-2">15+</h4>
                <p className="text-gray-600">Ethiopian Cities</p>
              </CardContent>
            </Card>

            <Card>
              <CardContent className="p-6 text-center">
                <div className="w-12 h-12 bg-eth-red/10 rounded-lg flex items-center justify-center mx-auto mb-4">
                  <Activity className="h-6 w-6 text-eth-red" />
                </div>
                <h4 className="text-2xl font-bold text-neutral-dark mb-2">100%</h4>
                <p className="text-gray-600">Authentic Experience</p>
              </CardContent>
            </Card>
          </div>
        </div>
