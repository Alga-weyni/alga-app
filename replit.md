...
- **E-Signature Consent System**: Legally compliant e-signature consent tracking based on Ethiopian Electronic Signature Proclamation No. 1072/2018 and Electronic Transactions Proclamation No. 1205/2020. Features reusable ConsentNotice and ConsentButton components that automatically record consent with full audit trail (user ID, IP address, user agent, identification method - Fayda ID/OTP phone/email, timestamp, related entity). Provides legal traceability for all bookings, payments, and confirmations.
